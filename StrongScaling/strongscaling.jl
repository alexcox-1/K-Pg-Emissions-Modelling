...
# Get MPI properties
    ...
    for k = 1:1
        ...
        all_ll_dist = MPI.Allgather(lldist, 0, comm)
        ...
        all_co2_dist = MPI.Allgather(co2dist, 0, comm)
        all_s_dist = MPI.Allgather(sdist, 0, comm)
        all_temps = MPI.Allgather(muarray, 0, comm)
