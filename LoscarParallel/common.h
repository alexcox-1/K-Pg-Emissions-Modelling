...
int *kkv,*kiv,ldrestart,svrestart,ffflag,tsnsflag,ltem,cntrfflag,
    fconv,cinpflag,sflag,ltSem,ltExp,expflag,reminflag,ltRemin,carbflag,ltCarb;
double *vb,*ab,*hb,thc0,thc,t0,tfinal,*ystart,*mxv,*mhd,thbra,thbri,
       ...
       *tCarb,*yCarb;
/* file names */
char fpldstr[BUFSIZ],fpsvstr[BUFSIZ],ffldstr[BUFSIZ],sldstr[BUFSIZ],expldstr[BUFSIZ],reminldstr[BUFSIZ],carbldstr[BUFSIZ];
