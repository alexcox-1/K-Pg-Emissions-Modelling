...
d13cages = d13cdata["age"][781:end];
d13cvals = d13cdata["d13c"][781:end];
...
(c, m, e) = bin_bsr(d13cbenthicages, d13cbenthicvals, -0.5, 1, 300; x_sigma=Age_benthic_sigma, y_sigma=d13cbenthicsigma, nresamplings=10000, p=1.0)
